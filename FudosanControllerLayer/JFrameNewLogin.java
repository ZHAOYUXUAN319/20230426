 ...
 * @author hangt
 */
public class JFrameNewLogin extends javax.swing.JFrame {

    /**
     * Creates new form FrameNewLogin
     */
    public JFrameNewLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("新規パスワード");

        jLabel2.setText("新規ID");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            bukenService.usersInsert(id, password, phone);

        } catch (SQLException ex) {
            Logger.getLogger(JFrameNewLogin.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
...
//            java.util.logging.Logger.getLogger(JFrameNewLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
